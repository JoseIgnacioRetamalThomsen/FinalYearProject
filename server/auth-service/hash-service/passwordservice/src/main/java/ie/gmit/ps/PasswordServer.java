...
/***
 *
 *  Runs {@code PasswordServiceIMP} using netty server, if TSL is provided will run with TSL.
 *
 * Code modified from :
 * {@link "https://github.com/grpc/grpc-java/blob/master/examples/example-tls/src/main/java/io/grpc/examples/helloworldtls/HelloWorldServerTls.java"}
 * {@link "https://github.com/john-french/distributed-systems-labs/tree/master/grpc-async-inventory"}
 */
public class PasswordServer {
     ...
     */
    public PasswordServer(int port,
    ...
    private void start() throws IOException {
        ...
        if (privateKeyFilePath != null) {
            ...
            server = NettyServerBuilder.forPort(port)
                    .addService(new PasswordServiceImp())
